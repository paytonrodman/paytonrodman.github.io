...
{{< figure library="true" src="inflow_zero_0001.png" style="float: left; width: 45%">}}
{{< figure library="true" src="inflow_zero_0002.png" style="float: left; width: 45%">}}

{{< figure library="true" src="inflow_zero_0003.png" style="float: left; width: 45%">}}
{{< figure library="true" src="inflow_zero_0004.png" style="float: left; width: 45%">}}
